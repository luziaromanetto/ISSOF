...
class ofPgReader : public ofTReader<sTraits>
{
public:
...
template <class sTraits>
ofPgReader<sTraits>::ofPgReader(int threads_vertices, int threads_cells)
        :ofTReader<sTraits>(threads_vertices, threads_cells)
{}

template <class sTraits>
ofPgReader<sTraits>::~ofPgReader()
{}

template <class sTraits>
bool ofPgReader<sTraits>::read(sMesh* malha, char* xml)
{
    OF_ASSERT(malha);
    OF_ASSERT(xml);
...
template <class sTraits>
void* ofPgReader<sTraits>::threadPoint(ofTReaderData* obj)
{
    OF_ASSERT(obj);
    PGconn     *conn;
    PGresult   *res;
...
template <class sTraits>
void* ofPgReader<sTraits>::threadCell(ofTReaderData* obj)
{
    OF_ASSERT(obj);
    PGconn     *conn;
    PGresult   *res;
