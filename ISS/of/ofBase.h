...
template <class _Traits>
bool ofBase<_Traits>::inMesh(OF_DMUTEX)
{
    OF_LOCK(smutex);
...
template <class _Traits>
void ofBase<_Traits>::setInMesh(bool value OF_DMUTEXV)
{
    OF_LOCK(smutex);
...
template <class _Traits>
void ofBase<_Traits>::setPosition(ids position OF_DMUTEXV)
{
    OF_LOCK(smutex);
...
template <class _Traits>
IDS ofBase<_Traits>::getPosition(OF_DMUTEX)
{
    OF_LOCK(smutex);
...
#ifdef OF_THREADS
template <class _Traits>
void ofBase<_Traits>::lock()
{
    pthread_mutex_lock(&smutex);
}

template <class _Traits>
void ofBase<_Traits>::unlock()
{
    pthread_mutex_unlock(&smutex);
}

template <class _Traits>
int ofBase<_Traits>::trylock()
{
