...
class ofBoundaryCellIterator2D : public ofIterator<_Traits>
{
public:
...
template <class _Traits>
ofBoundaryCellIterator2D<_Traits>::ofBoundaryCellIterator2D(sMesh *_mesh)
...
template <class _Traits>
ofBoundaryCellIterator2D<_Traits>::~ofBoundaryCellIterator2D()
{}

template <class _Traits>
bool ofBoundaryCellIterator2D<_Traits>::initialize(ids init, int edge)
{
    if (init < 0)
    {
...
template<class _Traits>
bool ofBoundaryCellIterator2D<_Traits>::operator++()
{
    sCell *tempc = atu;
...
template<class _Traits>
SCELL* ofBoundaryCellIterator2D<_Traits>::operator->()
{
    return atu;
}
...
template<class _Traits>
IDS ofBoundaryCellIterator2D<_Traits>::operator&()
{
    return iatu;
}

template<class _Traits>
bool ofBoundaryCellIterator2D<_Traits>::finish()
{
    return ((status == 2)||(status == 3));
}

template<class _Traits>
bool ofBoundaryCellIterator2D<_Traits>::notFinish()
{
    return ((status == 0)||(status == 1));
}

template<class _Traits>
int ofBoundaryCellIterator2D<_Traits>::getEdge()
{
    if(status != 0)
        return eatu;
