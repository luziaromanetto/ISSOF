...
class ofMeshSurface : public ofMeshOper<_Traits>
{
public:
...
template <class _Traits>
ofMeshSurface<_Traits>::ofMeshSurface(sMesh *_mesh)
        : ofMeshOper<_Traits>(_mesh)
{}

template <class _Traits>
ofMeshSurface<_Traits>::~ofMeshSurface()
{}

template <class _Traits>
void ofMeshSurface<_Traits>::addCell(ids idcell, ids *idvertices OF_DMUTEXV)
{
...
template <class _Traits>
void ofMeshSurface<_Traits>::delCell(ids idcell OF_DMUTEXV)
{
    int i, pos;
    sCell *cop, *c = this->mesh->getCell(idcell);
    sVertex *v[3] =
        { this->mesh->getVertex(c->getVertexId(0)), this->mesh->getVertex(c->getVertexId(1)), this->mesh->getVertex(c->getVertexId(2))};
    ids icop;
