...
class ofVertexStarIteratorSurface : public ofIterator<_Traits>
{
public:
...
template <class _Traits>
ofVertexStarIteratorSurface<_Traits>::ofVertexStarIteratorSurface(sMesh *_mesh)
...
template <class _Traits>
ofVertexStarIteratorSurface<_Traits>::~ofVertexStarIteratorSurface()
{}

template <class _Traits>
bool ofVertexStarIteratorSurface<_Traits>::initialize(ids init)
{
    OF_ASSERT(init >= 0);
...
template<class _Traits>
bool ofVertexStarIteratorSurface<_Traits>::operator++()
{
    if(status == 1)
    {
        if(iatu < 0)
...
template<class _Traits>
void ofVertexStarIteratorSurface<_Traits>::addNeighbor()
{
    ids temp;
...
template<class _Traits>
SCELL* ofVertexStarIteratorSurface<_Traits>::operator->()
{
    return atu;
}
...
template<class _Traits>
IDS ofVertexStarIteratorSurface<_Traits>::operator&()
{
    return iatu;
}

template<class _Traits>
bool ofVertexStarIteratorSurface<_Traits>::finish()
{
    return ((status == 2)||(status == 3));
}

template<class _Traits>
bool ofVertexStarIteratorSurface<_Traits>::notFinish()
{
