...
class ofCellsIterator : public ofIterator<_Traits>
{
public:
...
template <class _Traits>
ofCellsIterator<_Traits>::ofCellsIterator(sMesh *_mesh)
...
template <class _Traits>
ofCellsIterator<_Traits>::~ofCellsIterator()
{}

template <class _Traits>
bool ofCellsIterator<_Traits>::initialize(ids init)
{
    OF_ASSERT(init >= 0);
...
template<class _Traits>
bool ofCellsIterator<_Traits>::operator++()
{
...
template<class _Traits>
SCELL* ofCellsIterator<_Traits>::operator->()
{
    return atu;
}
...
template<class _Traits>
IDS ofCellsIterator<_Traits>::operator&()
{
    return iatu;
}

template<class _Traits>
bool ofCellsIterator<_Traits>::finish()
{
    return ((status == 2)||(status == 3));
}

template<class _Traits>
bool ofCellsIterator<_Traits>::notFinish()
{
