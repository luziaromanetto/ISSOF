...
template <class _Traits>
void ofBinaryIO<_Traits>::idsStore(ofstream &fp, ids num)
{
    unsigned char flag;
    unsigned char f = 0;
...
template <class _Traits>
IDS ofBinaryIO<_Traits>::idsLoad(ifstream &fp)
{
    ids num;
...
template <class _Traits>
void ofBinaryIO<_Traits>::spaceStore(ofstream &fp, space num)
{
    ids aprox;
...
template <class _Traits>
SPACE ofBinaryIO<_Traits>::spaceLoad(ifstream &fp)
{
    space num;
    ids aprox;
    unsigned char flag;
